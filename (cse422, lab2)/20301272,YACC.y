...
%token IF ELSE FOR WHILE PRINTLN RETURN INT FLOAT VOID ID CONST_INT CONST_FLOAT ADDOP MULOP RELOP LOGICOP ASSIGNOP NOT LPAREN RPAREN LCURL RCURL LTHIRD RTHIRD SEMICOLON COMMA INCOP DECOP DO BREAK CONTINUE CHAR DOUBLE SWITCH CASE DEFAULT DIVOP MODOP SUBOP
%nonassoc ELSE
%%
